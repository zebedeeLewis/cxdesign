...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/oyygqe61bM)
...
```sh
npx nx serve designio
```

To create a production bundle:

```sh
npx nx build designio
```

To see all available targets to run for a project, run:

```sh
npx nx show project designio
```
